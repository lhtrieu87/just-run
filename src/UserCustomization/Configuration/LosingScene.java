...
public class LosingScene extends Scene{
	...
	public LosingScene(int width, int height)
	{ 
	...
	private void initialize(int width, int height)
	{
		...
		Vector temp = font.MeasureString("You Lose !", true);
		m_lblText = new Label("You Lose !", font, (int)((width - temp.X) * 0.5), (int)((height - temp.Y) * 0.5), 
				true, m_ortho);
